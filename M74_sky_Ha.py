...
plt.title('M74 H$\\alpha$ - gradient')
...
out.writeto(path+'20241029/20241029_nograd_Ha01.fit', overwrite=True)
#plot
plt.figure()
plt.imshow(im_nograd[0], cmap='viridis', clim=[340, 400])
...
#plot zoom
plt.figure()
plt.imshow(im_nograd[0], cmap='viridis', clim=[340, 390])
plt.title('M74 H$\\alpha$ - 1 zoom')
plt.xlim(1500, 3000)
plt.ylim(2500, 1400)
plt.colorbar()
plt.show()
...
#save
out = fits.PrimaryHDU(im_nograd[1])
out.writeto(path+'20241029/20241029_nograd_Ha02.fit', overwrite=True)
#plot
plt.figure()
plt.imshow(im_nograd[1], cmap='viridis', clim=[330, 390])
plt.title('M74 H$\\alpha$ - 2')
plt.colorbar()
plt.show()

#save
out = fits.PrimaryHDU(im_nograd[2])
out.writeto(path+'20241029/20241029_nograd_Ha03.fit', overwrite=True)
#plot
plt.figure()
plt.imshow(im_nograd[2], cmap='viridis', clim=[330, 390])
