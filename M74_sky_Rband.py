...
print('...')
images = []
images.append(fits.open(path+'20241029/20241029_R01.fit')[0].data)
images.append(fits.open(path+'20241029/20241029_R02.fit')[0].data)
images.append(fits.open(path+'20241029/20241029_R03.fit')[0].data)
images.append(fits.open(path+'20241029/20241029_R04.fit')[0].data)
...
#plot
plt.figure()
plt.imshow(im_nograd[0], cmap='viridis', clim=[8050, 8300])
...
#plot zoom
plt.figure()
plt.imshow(im_nograd[0], cmap='viridis', clim=[8070, 8300])
...
#plot
plt.figure()
plt.imshow(im_nograd[1], cmap='viridis', clim=[7850, 8100])
...
#plot
plt.figure()
plt.imshow(im_nograd[2], cmap='viridis', clim=[7750, 8000])
plt.title('M74 r band - 3')
plt.colorbar()
plt.show()

#save
out = fits.PrimaryHDU(im_nograd[3])
out.writeto(path+'20241029/20241029_nograd_R04.fit', overwrite=True)
#plot
plt.figure()
plt.imshow(im_nograd[3], cmap='viridis', clim=[7600, 7850])
